            ...
            @foreach ($categories as $category)
                    <ul>
                        <li class="relative">
                            ...
                            <h3 class="text-lg underline absolute top-1 left-2 text-white p-1 font-medium tracking-widest bg-slate-700 z-10"><a href="/?category={{ $category->slug }}">{{ $category->name }}</a></h3>
                        </li>
                    </ul>
            @endforeach
        </div>
